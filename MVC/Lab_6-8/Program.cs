...
using CreditContext_MvcCreditApp;

var builder = WebApplication.CreateBuilder(args);
builder.Services.AddDbContext<Models_>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("Models_") ?? throw new InvalidOperationException("Connection string 'Models_' not found.")));
